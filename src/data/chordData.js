...
export const CHORD_EXTENSIONS = [3, 7, 9, 11, 13];
...
const FORMULAS = {
    'Major': { triad: [0, 4, 7], 7: 11, 9: 14, 11: 17, 13: 21 }, // Maj7, Maj9, etc.
    'Minor': { triad: [0, 3, 7], 7: 10, 9: 14, 11: 17, 13: 21 }, // m7, m9, etc.
    'Dominant': { triad: [0, 4, 7], 7: 10, 9: 14, 11: 17, 13: 21 }, // 7, 9, 11, 13
    'Aug': { triad: [0, 4, 8], 7: 10, 9: 14, 11: 17, 13: 21 }, // Aug triad, Aug7 (7#5)
    'Dim': { triad: [0, 3, 6], 7: 9, 9: 14, 11: 17, 13: 21 }, // Dim triad, Dim7 (bb7)
    'HalfDim': { triad: [0, 3, 6], 7: 10, 9: 14, 11: 17, 13: 21 }, // m7b5
    'Sus2': { triad: [0, 2, 7], 7: 10, 9: 14, 11: 17, 13: 21 }, // 7sus2
    'Sus4': { triad: [0, 5, 7], 7: 10, 9: 14, 11: 17, 13: 21 } // 7sus4
};
